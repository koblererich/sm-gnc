...
\icmlauthor{Erich Kobler}{x}
\icmlauthor{Thomas Pock}{y}
...
\icmlaffiliation{x}{Department of Neuroradiology, University Hospital Bonn, Bonn, Germany}
\icmlaffiliation{y}{Institue of Computer Graphics and Vision, Graz University of Technology, Graz, Austria}

\icmlcorrespondingauthor{Erich Kobler}{erich.kobler@ukbonn.de}
...
\node at (-8.3,0) {\includegraphics[width=.35\linewidth]{./figures/ex_gmm/ex_gmm_func}};
\node at (0,0) {\includegraphics[width=.6\linewidth]{./figures/ex_gmm/ex_gmm_rate}};
% \draw[black, thick] (4.7,2.6) -- (4.7,-2.4);
\fill[red, opacity=.1] (4.7-2.1,2.15) rectangle (4.7+.4,-2.45);
\node[text=red, anchor=south] at (4.,-2.5) {non-convex};
\fill[green, opacity=.1] (4.7-2.1,2.15) rectangle (4.7+.4,2.15+.5);
% \fill[green, opacity=.1] (4.7+.4,2.6) rectangle (4.7,-2.4);
\node[text=green, anchor=north] at (4.,2.65) {convex};
\end{tikzpicture}
