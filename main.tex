...
\icmltitlerunning{TODO change template to 2023}

\begin{document}

\twocolumn[
\icmltitle{On Links between Diffusion Models, Graduated non-convexity, and\\ Variational Networks}
...
The plot on the right in \figref{fig:gmmOptimization} visualizes the rate of trajectories converging to the global minimum as a function of the initial smoothing~$t_0$.
